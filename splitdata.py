...
#     adjusted_close_values = [val["5. adjusted close"] for val in data.values()]
#     mid_index = len(data) // 2

#     first_half_dates = dates[:mid_index]
#     first_half_values = adjusted_close_values[:mid_index]

#     second_half_dates = dates[mid_index:]
#     second_half_values = adjusted_close_values[mid_index:]

#     print("First half dates: " , first_half_dates)
#     print("First half values: ", first_half_values)
#     print("Second half dates: ", second_half_dates)
#     print("Second half values: ", second_half_values)

#     plt.plot(first_half_dates, first_half_values, color = 'blue')
#     plt.plot(second_half_dates, second_half_values, color = 'red', linestyle='--')
...
#     # print(first_half_dates, first_half_values, second_half_dates, second_half_values)
